...
class FuncionarioController extends AbstractController
{
    ...
    /**
     * @Route("/novo", name="funcionario_novo", methods="GET|POST")
     */
    ...
    /**
     * @Route("/{id}", name="funcionario_ver", methods="GET")
     */
    public function show(Funcionario $funcionario): Response
    {
        return $this->render('funcionario/ver.html.twig', ['funcionario' => $funcionario]);
    }

    /**
     * @Route("/{id}/editar", name="funcionario_editar", methods="GET|POST")
     */
    public function edit(Request $request, Funcionario $funcionario): Response
    {
        ...
        return $this->render('funcionario/editar.html.twig', [
            'funcionario' => $funcionario,
            'form' => $form->createView(),
        ]);
    }
